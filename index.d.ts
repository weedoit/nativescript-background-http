...
export interface Request {
    ...
    /*
     * Use this to set the message shown in the Android notifications center.
     */
    androidNotificationMessages?: {
        completed?: string;
        progress?: string;
        error?: string;
        cancelled?: string;
    ...
    /*
     * Use this to set if notifications should be cleaned automatically after upload
     */
